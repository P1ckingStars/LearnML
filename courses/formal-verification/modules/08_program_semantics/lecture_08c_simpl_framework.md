...
4. Hoare triples include both normal and abrupt postconditions: $\{P\}\, c\, \{Q\},\, \{A\}$.
5. SIMPL's Hoare logic is proved sound and relatively complete.
6. The C parser translates C source code into SIMPL programs, enabling verified C code.
