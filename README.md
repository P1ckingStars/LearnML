...
|--------|-------|-------|------------|
| 00 | [Mathematical Foundations](modules/00_foundations/) | Pre-work | Linear algebra, probability, optimization |
| 01 | [Neural Nets & Backprop](modules/01_mlp_backprop/) | 1–2 | Universal approximation, autodiff, regularization |
| 02 | [Convolutional Networks](modules/02_cnns/) | 3–4 | Equivariance, ResNet, normalization, detection |
| 03 | [Sequence Models](modules/03_sequence_models/) | 5–6 | RNNs, LSTMs, language modeling, seq2seq |
| 04 | [Attention & Transformers](modules/04_attention_transformers/) | 7–8 | Attention, transformer architecture, efficient variants |
| 05 | [LLMs & Pretraining](modules/05_llms_pretraining/) | 9–10 | Scaling laws, GPT/BERT/LLaMA, tokenization |
| 06 | [Alignment & Post-Training](modules/06_alignment/) | 11–12 | SFT, RLHF, DPO, LoRA |
| 07 | [Generative Models](modules/07_generative_models/) | 13–14 | VAEs, normalizing flows, EBMs, score matching |
| 08 | [Diffusion Models](modules/08_diffusion/) | 15–16 | DDPM, score SDEs, flow matching, guidance |
| 09 | [Frontier Architectures](modules/09_frontier/) | 17–18 | SSMs, Mamba, MoE, multimodal models |
| 10 | [Agents & Inference-Time](modules/10_agents_inference/) | 19–20 | Tool use, RAG, chain-of-thought, test-time compute |
